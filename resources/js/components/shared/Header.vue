    ...
    <div class="header-navigation">
      ...
      >
        ...
        <div class="nav-push-item-container">
          <!-- nav push item -->
          <div
            class="nav-push-item d-none d-xl-block"
            style="display: none"
            v-if="store.user == null"
          >
            <div class="navbar-btn">
              <router-link :to="{ name: 'login' }" class="main-btn"
                ><i class="fal fa-sign-in-alt"></i>Login</router-link
              >
            </div>
          </div>
          <div
            class="nav-push-item d-flex justify-content-between"
            style="display: none"
            v-if="store.user != null"
          >
            <div class="navbar-btn">
            ...
            <div class="navbar-btn ml-2">
              <a href="#" class="main-btn bg-danger" @click="logout"
